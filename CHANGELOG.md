...
- [#879](https://github.com/nf-core/eager/issues/879) Add missing threads parameter to pre-clipping FastQC for single end data that caused insufficient memory in some cases (♥ to @marcel-keller for reporting)
