...
* [#286](https://github.com/nf-core/eager/issues/286) - Added ability to use institute specific profiles for EAGER (following [https://maxulysse.github.io/2019/11/21/adding-pipeline-specific-config/](https://maxulysse.github.io/2019/11/21/adding-pipeline-specific-config/))
