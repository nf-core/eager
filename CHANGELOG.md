...
- [#885](https://github.com/nf-core/eager/issues/879) Specify task memory for all tools in get_software_versions to account for java incompatibilty with some SGE clusters causing hanging of the process (♥ to @maxibor for reporting)
