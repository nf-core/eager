...
//TO DO: all the tests bellow!!

##Check if mapping only has been performed, meaning params.run_bamfiltering is false and params.skip_deduplication is true

nextflow run ../main.nf -profile docker,test --outdir results_endorspy_map_only -w results_endorspy_map_only/work --skip_deduplication
...
nextflow run ../main.nf -profile docker,test --outdir results_endorspy_map_filtering_nodedup -w results_endorspy_map_filtering_nodedup/work
