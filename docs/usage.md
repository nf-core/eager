...
- [nf-core/eager: Usage](#nf-coreeager-usage)
  ...
  - [Tutorials](#tutorials)
    ...
    - [Tutorial - How to set up nf-core/eager for human population genetics](#tutorial---how-to-set-up-nf-coreeager-for-human-population-genetics)
      ...
      - [Tutorial Human Pop-Gen - Summary](#tutorial-human-pop-gen---summary)
    ...
    - [Tutorial - How to set up nf-core/eager for pathogen genomics](#tutorial---how-to-set-up-nf-coreeager-for-pathogen-genomics)
      - [Tutorial Pathogen Genomics - Introduction](#tutorial-pathogen-genomics---introduction)
      - [Tutorial Pathogen Genomics - Preparation](#tutorial-pathogen-genomics---preparation)
      - [Tutorial Pathogen Genomics - Inputs and Outputs](#tutorial-pathogen-genomics---inputs-and-outputs)
      - [Tutorial Pathogen Genomics - Pipeline Configuration](#tutorial-pathogen-genomics---pipeline-configuration)
      - [Tutorial Pathogen Genomics - Results](#tutorial-pathogen-genomics---results)
        - [Tutorial Pathogen Genomics - MultiQC Report](#tutorial-pathogen-genomics---multiqc-report)
        - [Tutorial Pathogen Genomics - Files for Downstream Analysis](#tutorial-pathogen-genomics---files-for-downstream-analysis)
      - [Tutorial Pathogen Genomics - Clean up](#tutorial-pathogen-genomics---clean-up)
      - [Tutorial Pathogen Genomics - Summary](#tutorial-pathogen-genomics---summary)
