...
```bash
nextflow run nf-core/eager -profile <docker/singularity/conda/institute> --reads '*_R{1,2}.fastq.gz' --genome GRCh37
```
...
nf-core/eager was originally written by Alexander Peltzer, Stephen Clayton, James A. Fellows Yates, Maxime Borry, Thiseas C. Lamnidis, Zandra Fagernäs.

## Contributions and Support

If you would like to contribute to this pipeline, please see the [contributing guidelines](.github/CONTRIBUTING.md).

For further information or help, don't hesitate to get in touch on [Slack](https://nfcore.slack.com/channels/eager) (you can join with [this invite](https://nf-co.re/join/slack)).
