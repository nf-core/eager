...
workflow METAGENOMICS_PROFILING {
    ...
    */
    ...
    if ( params.metagenomics_profiling_tool == 'krakenuniq' ) {
        ...
        KRAKENUNIQ_PRELOADEDKRAKENUNIQ ( ch_input_for_krakenuniq.reads, ch_input_for_krakenuniq.db, params.metagenomics_profiling_krakenuniq_ram_chunk_size, params.metagenomics_profiling_krakenuniq_save_reads, true, params.metagenomics_profiling_krakenuniq_save_readclassifications )
    ...
    if ( params.metagenomics_profiling_tool == 'kraken2' ) {
        ...
        KRAKEN2_KRAKEN2 ( ch_input_for_kraken2.reads, database, params.metagenomics_profiling_kraken2_save_reads, params.metagenomics_profiling_kraken2_save_readclassification )
