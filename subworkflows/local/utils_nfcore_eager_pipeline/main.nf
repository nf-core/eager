...
def validateInputParameters() {
    ...
    if ( params.fasta && params.mapping_tool == "circularmapper" && ! params.fasta_circular_target && ! params.mapping_circularmapper_elongated_fasta ) { exit 1, ("[nf-core/eager] ERROR: Mapping with circularmapper requires either --fasta_circular_target or --mapping_circularmapper_elongated_fasta. ") }
}
