...
workflow REFERENCE_INDEXING_SINGLE {
    ...
    ch_reference_for_mapping = ch_ungz_ref
                                ...
                                .map{
                                    ...
                                    [ meta + [ ploidy: genotyping_gatk_ploidy ], fasta, fai, dict, mapper_index, params.fasta_circular_target, params.mitochondrion_header, contamination_estimation_angsd_hapmap, pmd_mask, capture_bed, pileupcaller_bed, pileupcaller_snp, sexdet_bed, bedtools_feature, genotyping_gatk_dbsnp ]
                                }
